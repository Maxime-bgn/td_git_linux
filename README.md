...
To modify a commit that is farther back in your history, you must use an interactive rebase. For example, if you want to modify a commit message that is three commits back, you can use the -i option to the git rebase command. This will put you into an editor with a list of recent commits and some instructions on how to edit them.
